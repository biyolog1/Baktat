<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">
            Eğitim Listesi
            <a href="<?php echo base_url("Courses/new_form"); ?>" class="btn  btn-primary btn-sm pull-right">
            ...
            <?php if (empty($items)) { ?>
                <div class="alert alert-info text-center  ">
                    ...
                    <p> Burada herhangi bir veri bulunmamaktadır. Eklemek için lütfen <a
                                href="<?php echo base_url("Courses/new_form"); ?>">tıklayınız.</a></p>
                </div>
            <?php } else { ?>
                <table id="default-datatable" data-plugin="DataTable"
                    ...
                    <?php foreach ($items as $item) { ?>
                        ...
                        <tr id="ord-<?php echo $item->id; ?>">
                            ...
                            <td class="w150"><?php echo get_readable_date($item->event_date); ?></td>
                            <td><?php echo $item->description; ?></td>
                            <td><img width="75" src="<?php echo base_url("uploads/$viewFolder/$item->img_url") ?>"
