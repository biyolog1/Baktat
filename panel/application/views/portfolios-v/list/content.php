<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">
            Portfolyo Listesi
            <a href="<?php echo base_url("Portfolios/new_form"); ?>" class="btn  btn-primary btn-sm pull-right">
            ...
            <?php if (empty($items)) { ?>
                <div class="alert alert-info text-center">
                    ...
                    <p> Burada herhangi bir veri bulunmamaktadır. Eklemek için lütfen <a
                                href="<?php echo base_url("Portfolios/new_form"); ?>">tıklayınız.</a></p>
                </div>
            <?php } else { ?>
                ...
                <?php foreach ($items as $item) { ?>
                    ...
                    <tr  id="ord-<?php echo $item->id; ?>">
                        ...
                        <td class="w300">
                            ...
                            <a href="<?php echo base_url("Portfolios/update_form/$item->id"); ?>"
                               class="btn btn-sm btn-info "><i class="fa fa-pencil-square-o"></i> Düzenle
                            </a>
                            <a href="<?php echo base_url("Portfolios/image_form/$item->id"); ?>"
                               class="btn btn-sm btn-purple "><i class="fa fa-picture-o"></i> Resimler </a>
                        </td>
                    </tr>
