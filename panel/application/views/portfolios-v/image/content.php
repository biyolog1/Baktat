    ...
    <div class="col-md-12">
        <div class="widget">
            ...
            <div class="widget-body">
                <form data-url="<?php echo base_url("Portfolios/refresh_image_list/$item->id"); ?>" action="<?php echo base_url("Portfolios/image_upload/$item->id"); ?>" id="dropzone" class="dropzone"
                      data-plugin="dropzone"
                      data-options="{ url: '<?php echo base_url("Portfolios/image_upload/$item->id"); ?>'}">
